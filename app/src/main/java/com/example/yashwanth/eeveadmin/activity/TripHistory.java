...
public class TripHistory extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listViewTripHistory = (ListView) findViewById(R.id.listViewTripHistory);
        listViewTripHistory.setOnItemClickListener(this);
    ...
    private void showEmployee(){
        ...
        try {
            ...
            for(int i = 0; i<result.length(); i++){
                ...
                String model = jo.getString(Config.TAG_MODEL);
                String reg_no = jo.getString(Config.TAG_REG_NO);
                String start = jo.getString(Config.TAG_START);
                String end = jo.getString(Config.TAG_END);
        ...
        ListAdapter adapter = new SimpleAdapter(
                TripHistory.this, list, R.layout.list_item_trip_history,
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(TripHistory.this,"Fetching Data","Wait...",false,false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String res = rh.sendPostRequest(Config.URL_GET_TRIP_HISTORY, params2);
                return res;
                //return s;
