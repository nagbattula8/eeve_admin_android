...
import com.example.yashwanth.eeveadmin.app.AppConfig;
import com.example.yashwanth.eeveadmin.app.AppController;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                String lattitude1 = lattitude.getText().toString().trim();
                String longitude1 = longitude.getText().toString().trim();

                name = name + ";;;;;" + address + ";;;;;" + lattitude1 + ";;;;;" + longitude1;

                if (!name.isEmpty() && !email.isEmpty() && !password.isEmpty()) {
                    registerUser(name, email, password);

                   // Log.e("Details",name + "  " + email+ password);
                } else {
